import pandas as pd
from src.etl.etl_processor import clean_and_type_data, calculate_indicators
...
def test_calculate_indicators():
    ...
    print("\n1. Return")
    print(df_result.loc[0:2,
        ["trading_date", "close_price", "return"]].to_markdown(index=False))
    ...
    print(df_result.loc[18:19, ['trading_date', 'close_price', 'ma20']].to_markdown(index=False))
    assert df_result.loc[19, "ma20"] == 10.5, \
        "MA20 calculation failed!"
    
    print("\n3. RSI")
    print(df_result.loc[18:19,
        ["trading_date", "close_price", "rsi_14"]].to_markdown(index=False))
