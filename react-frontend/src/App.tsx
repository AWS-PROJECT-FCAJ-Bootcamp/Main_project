...
// ── Admin page
const AdminPanel = lazy(() => import('./features/auth/AdminPanel').then((m) => ({ default: m.AdminPanel })));
...
const SessionDetail     = lazy(() => import('./features/sessions/SessionDetail').then((m) => ({ default: m.SessionDetail })));
      ...
      <BrowserRouter>
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            {/* Protected routes — all require authentication + active status */}
            <Route element={<ProtectedRoute />}>
              <Route element={<AppLayout />}>
                {/* Admin-only routes */}
                <Route element={<RoleGuard role="admin" fallback="/dashboard" />}>
                  <Route path="/admin" element={<AdminPanel />} />
                </Route>

                {/* Common routes (guest + admin) */}
