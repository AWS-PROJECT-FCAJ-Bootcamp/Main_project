...
- **Phân vùng S3 (Partitioning):** 
  `s3://<raw-bucket-name>/ohlcv/year=YYYY/month=MM/day=DD/data.json`
...
4. **Phạm vi dữ liệu (Scope):** Cấu hình thu thập giới hạn trong danh sách 100 mã VN100 (Sẽ scale up tùy biến theo cấu hình hệ thống).